...
import { CheckCircle2, ArrowRight, Home, ShoppingBag, ShieldCheck } from 'lucide-react';
    ...
    <div className="bg-[#FAF8F4] py-16 sm:py-24 min-h-[70vh] flex items-center justify-center text-center">
      <div className="max-w-lg mx-auto px-6">
        ...
        <p className="text-sm sm:text-base text-[#6B6B6B] mt-3 leading-relaxed">
          Thank you, <strong>{customerName}</strong>! Your order has been received. This is a frontend prototype and no real payment was processed.
        </p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5">
          <a
            href="#products"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3 rounded-full bg-[#222222] hover:bg-[#333333] text-white text-sm font-medium transition duration-150 active:scale-95 shadow-xs"
          >
